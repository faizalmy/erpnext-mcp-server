...
def _register_resources(mcp) -> None:
    """Register MCP resources (read-only structured data)."""
...
log.info("Registered %d total tools (%d auto-discovered + %d curated)",
         _total_tools, crud_count, _total_tools - crud_count)
